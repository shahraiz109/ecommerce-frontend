...
const ShopeCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        console.log(
          "🚀 ~ file: Signup.jsx:28 ~ .then ~ res.data.message:",
          res.data.message
        );
        setName("");
        setEmail("");
      ...
      .catch((error) => {
        console.log("🚀 ~ file: Signup.jsx:34 ~ handleSubmit ~ error:", error);
      if (
        error.response &&
        error.response.data &&
        ...
        // Handle the error in case the expected properties are not present
  ...
  return (
    <div className="min-h-screen bg-gray-50  flex-col justify-center flex items-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 text  sm:max-auto sm:w-full sm:max-w-[35rem]">
        <div className=" bg-white py-8 px-4 shadow sm:rounded sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className={`${style.noramlFlex} w-full`}>
              ...
              <Link to="/shope-login" className="text-blue-600">
                Sign In
              </Link>
            </div>
          </form>
